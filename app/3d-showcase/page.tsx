  ...
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-8 grid grid-cols-1 gap-10">
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <div>
          <h2 className="font-medium mb-2">Interactive 3D Models</h2>
          <ToothModelViewer height="400px" />
        </div>
        <div>
          <h2 className="font-medium mb-2">AR Smile Try‑On</h2>
          <ARSmileTryOn />
        </div>
      </section>

      <section>
        <h2 className="font-medium mb-2">Before / After</h2>
        <BeforeAfterViewer height="420px" />
      </section>

      <section>
        <h2 className="font-medium mb-2">Virtual Office Tour</h2>
        <VirtualOfficeTour height="560px" autoPlay />
      </section>
    </main>
  );
}
