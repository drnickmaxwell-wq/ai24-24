    ...
    <section className="relative py-16">
      <div className="mx-auto w-full max-w-[1200px] px-6">
        <div className="rounded-2xl p-10 bg-gradient-to-r from-[var(--magenta)]/10 to-[var(--turquoise)]/10 border border-white/30 backdrop-blur-md">
          ...
          <p className="mt-2 text-[var(--text)]/80 max-w-2xl">
            Answer a few quick questions and get a personalised smile plan. Takes about 60 seconds.
          </p>
          <div className="mt-6">
            <a
              href="/ai-smile-quiz"
              className="inline-block px-5 py-3 rounded-full text-white font-medium shadow-lg
