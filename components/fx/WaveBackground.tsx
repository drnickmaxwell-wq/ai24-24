...
let Impl:any;
try {
  // Use your original effect if present: /components/effects/WaveBackground.tsx
  // @ts-ignore
  Impl = require('../effects/WaveBackground').default;
} catch {
  // Fallback so Luxe hero never explodes
...
export default function WaveBackground(props:{amplitude?:number}) { return <Impl {...props} />; }
